this.wordle = this.wordle || {}, // ^^ what is this? should I delete or will it make everything fall apart? 
...
// ^^ wtf even is this 
    ...
    Ca("config", "G-2SSGMHY3NP", {
        ...
        debug_mode: !1
    }); // all the potential five letter words that could be generated, that the user will be forced to guess 
    var SOLUTION_LIST = ["cigar", "awake", "blush", "evade", "naval", "serve", "heath", "dwarf", "model", "karma", "stink", "grade", "quiet", "bench", "abate", "feign", "major", "death", "fresh", "crust", "stool", "colon", "abase", "marry", "react", "batty", "pride", "floss", "helix", "croak", "staff", "paper", "unfed", "whelp", "trawl", "outdo", "adobe", "crazy", "sower", "repay", "digit", "crate", "cluck", "spike", "mimic", "pound", "maxim", "linen", "unmet", "flesh", "booby", "forth", "first", "stand", "belly", "ivory", "seedy", "print", "yearn", "drain", "bribe", "stout", "panel", "crass", "flume", "offal", "agree", "error", "swirl", "argue", "bleed", "delta", "flick", "totem", "wooer", "front", "shrub", "parry", "biome", "lapel", "start", "greet", "goner", "golem", "lusty", "loopy", "round", "audit", "lying", "gamma", "labor", "civic", "forge", "basic", "salad", "agate", "spicy", "spray", "essay", "fjord", "feast", "quits", "doses"]
      , WORD_LIST = ["aahed", "aalii", "aargh", "beers"]
      , Ia = "present"
      , Ma = "correct"
      , Oa = "absent";
    var Ra = {
    ...
    let Qa = document.createElement("template");
...
`;
    ...
    // ^^ SEEMS to be the end 'play again' pop-up screen??
    Is.innerHTML = `
    <div class="countdown">
